...
@CucumberOptions(
                    ...
                    publish = false,                                     // it will give you public link of your local html report
                    plugin = {"pretty",
...
//                    ,tags= "@ui"                           //if we want run multiple tags - >  @smoke and @wip                                        // it runs the Feature or Scenario with the given tag we gave to a
                )
